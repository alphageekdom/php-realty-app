...
@section('page-title', 'Login - A|G Realty')
@section("content")
    <div class="auth-page auth-page--login">
        <form method="POST" action="{{ route('login') }}" class="auth-page__form">
            ...
            <div class="auth-page__form-group">
                <label for="remember" class="auth-page__form-label">Remember Me  <input id="remember_me" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="remember" /> </label>
            </div>
            <div class="auth-page__form-group">
